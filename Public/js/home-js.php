...
?>
 ...
 <?PHP if ($lang == PHP_EN): ?>
   ...
   alert("Here how to manage your avatars in Musicing\n" +
         ...
         "   a. Drop in mp3 files to shape your music blog, in the form 'Playlist~Song Title.mp3';\n" +
  ...
  <?PHP elseif ($lang == PHP_IT): ?>       
   ...
   alert("Ecco come gestire i tuoi avatar in Musicing:\n" +
         ...
         "   a. Trascina .mp3 file per creare il tuo blog musicale, attenendoti a 'Playlist~Titolo Canzone.mp3'\n" +
  ...
  <?PHP elseif ($lang == PHP_CN): ?>              
   ...
   alert("在这里如何免费管理您的化身:\n" +
         ...
         "   a. 放入.txt文件以形成您的博客:'Playlist~Song Title.mp3'.\n" +
  ...
  function playSong(playlist, song) {
    //document.getElementById("myPlayer").src = "http://<?PHP echo(APP_HOST);?>/media/" + encodeURI(playlist) + "/" + song;
    document.getElementById("myPlayer").src = "/audio?av=<?PHP echo($AVATAR_NAME); ?>&f=/" + encodeURI(playlist) + "/" + song;
    document.getElementById("myPlayer").volume = 1;
    document.getElementById("myPlayer").play(); 
  }
