...
function changeLang(tthis) {
  ...
  switch (lang) {
    case "en-US":
       ...
       break;
    case "it-IT":
       window.open("https://bsdload-com.translate.goog/bsd?_x_tr_sl=auto&_x_tr_tl=it&_x_tr_hl=en&_x_tr_pto=wapp","_self");
       break;
    case "zh-CN":
       //window.open("https://bsdload-com.translate.goog/433?_x_tr_sl=auto&_x_tr_tl=zh&_x_tr_hl=en&_x_tr_pto=wapp","_self");
       window.open("http://webtrans.yodao.com/webTransPc/index.html?from=en&to=zh-CHS&type=1&url=https%3A%2F%2Fbsdload.com%2Fbsd", "_self");
       break;
   }    
